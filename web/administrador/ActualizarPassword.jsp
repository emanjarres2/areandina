<%-- 
    ...
    Created on : 14/08/2020, 02:05:36 PM
    Author     : emanjarres
--%>
...
<html>
    <head>
        ...
        <title>SIGMAA | Actualizar Password</title>
...
<%-- Cuerpo de la página --%>
<form action="../ActualizarContrasena?actualizar=administrador" method="POST" name="formularioActualizar" id="formularioActualizar"> 
    <div class="card-body">
...
<%-- Píe de la página --%>            
        <div class="card-footer text-center" style="margin-top:14.5%;">    
