 ...
 * @author emanjarres
 */
public class CrearProgramas extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            //String data="{\"registrarprograma\"{\"programa\":\""+programa+"\",\"modalidad\":\""+modalidad+"\",\"idFacultad\":"+idFacultad+"}}";
           // out.print(data);
            ...
            if(registrarprograma.registraProgramas(programa, modalidad, idFacultad)){
                response.sendRedirect("administrador/CrearProgramas.jsp");
            }else
