 ...
 * @author emanjarres
 */
public class ConsultaTutorias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Connection con =null;
           ...
           String datos="";
           try{
         String sql="select t.Id_tutorias, t.fecha,e.Name_estudiantes, s.nombre,f.Name_factor,us.Name_users,t.observaciones from tutorias t inner join estudiantes e on t.Id_estudiante=e.Documento inner join semestre s on t.semestre=s.Id_semestre inner join factor_asociado f on t.Id_factor=f.Id_factor inner join usuarios us on t.Id_tutor=us.Id_usuarios WHERE t.estado='abierto';";
         con=cn.getConexion();
