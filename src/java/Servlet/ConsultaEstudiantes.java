...
public class ConsultaEstudiantes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
           ...
           String datos="";
           try{
            String sql="SELECT estudiantes.Id_estudiante, estudiantes.Name_estudiantes, estudiantes.Mail_users, estudiantes.Phone_users, estudiantes.Estado_usuario, campus.Name_campus, facultad.Name_faculty, programa.Name_program, estudiantes.Semestre, estudiantes.Modalidad, estudiantes.Documento FROM estudiantes, Campus, facultad, programa WHERE estudiantes.Id_campus = campus.Id_campus AND facultad.Id_faculty=estudiantes.Id_faculty AND programa.Id_program=estudiantes.Id_program; ";
          con=cn.getConexion();
         ...
         while(rs.next()){
            ...
            item.addProperty("Id_estudiante", rs.getInt("Id_estudiante"));
            ...
            item.addProperty("Estado_usuario", rs.getString("Estado_usuario"));
